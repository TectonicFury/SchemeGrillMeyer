; in most Lisp implementations, dispatching on type is done in data directed style (using get and put)
(define (eval exp env)
...
(define (list-of-values-r2l exps env)
  (if (null? (cdr exps))
      ...
      (let ((rest-vals-list (list-of-values-r2l (cdr exps) env)))
        (cons (eval (first-operand exps) env) rest-vals-list))))
